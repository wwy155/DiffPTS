"""
D3U variant: DiffPTS-style cond_pred_model_g (SigmaEstimation), NLL trains gx;
diffusion forward noise uses gx; inference tiles gx like DiffPTS/D3U.
"""
...
class D3UEarlyStopping(EarlyStopping):
...
@dataclass
class D3UNllGxForecast(ProbForecastExp, D3UParameters):
    model_type: str = "D3U_nllgx"
    ...
    def _setup_early_stopper(self):
        ...
        self.early_stopper = D3UEarlyStopping(self.patience, verbose=True, path=self.run_save_dir)
